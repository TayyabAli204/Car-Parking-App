...
<StatusBar
    ...
    pages={[ 
      {
        backgroundColor: '#fff',
        image: <Image source={require('../../assets/img/onboarding.png')} style={{width: '100%',
        ...
        letterSpacing: 2,},
        subTitleStyles:{fontFamily: 'OpenSans-Regular',
      ...
      {
        backgroundColor: '#fff',
        image: <Image source={require('../../assets/img/onboard.png')} style={{width: widthPixel(254),
